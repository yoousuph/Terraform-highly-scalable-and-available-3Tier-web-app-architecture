    ...
    class DatabaseDemo extends Component {
        ...
        return (
            <div>
            <h1 id='title' style={{paddingRight:"1em"}}> Data Input </h1>
            <input style={{float:"left", marginBottom:"1em"}} type = "button" value ="DELETE ITEM" onClick={this.handleButtonClickDel} />
            <table id='transactions'>
               <tbody>
                   ...
                   <tr>
                        <td><input type = "button" value ="ADD ITEM" onClick={this.handleButtonClick}/></td>
